		...
		public function agregar_cliente_controlador(){
			...
			if($agregar_cliente->rowCount()==1){
				...
				$alerta=[
					"Alerta"=>"simple",
					"Titulo"=>"Ocurrió un error inesperado",
					"Texto"=>"No hemos podido registrar el cliente, por favor intenta de nuevo",
					"Tipo"=>"error"
				];
			}
			echo json_encode($alerta);
		...
		public function eliminar_cliente_controlador(){
			...
			if($eliminar_cliente->rowCount()==1){
				...
				$alerta=[
					"Alerta"=>"simple",
					"Titulo"=>"Ocurrió un error inesperado",
					"Texto"=>"No hemos podido eliminar el cliente, por favor intenta de nuevo",
					"Tipo"=>"error"
				];
			}
			echo json_encode($alerta);
		...
		public function actualizar_cliente_controlador(){
			...
			if(clienteModelo::actualizar_cliente_modelo($datos_cliente_up)){
				...
				$alerta=[
					"Alerta"=>"simple",
					"Titulo"=>"Ocurrió un error inesperado",
					"Texto"=>"No hemos podido actualizar los datos del cliente, por favor intenta de nuevo",
					"Tipo"=>"error"
				];
			}
			echo json_encode($alerta);
